...
// 1.2. Note que uma das caixas está um pouco acima das outras. Por que isso 
// ocorre?

// 2. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for 
// clicado.
...
// 3. Crie uma função que, ao digitar na caixa de texto, altere o texto do 
// elemento
// com a classe 'tech';
...
// 4. Crie uma função que, ao clicar duas vezes em 
// 'Meu top 3 do Spotrybefy', ele
// redirecione para alguma página;
// 4.1. Que tal redirecionar para seu portfólio?

myWebpage.addEventListener('dblclick', function() {
    window.location.replace('https://thalesdferreira.github.io/');
  });
